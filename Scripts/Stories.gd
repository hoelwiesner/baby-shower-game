...
6: {
	...
	"story" : "Je vais visiter ma famille française tout les %s. En Bretagne, je dévore les crêpes aux %s. Même quand il pleut %s fois par jour, j’aime %s dans la mer. Tour de France?…",
